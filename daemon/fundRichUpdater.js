  ...
  sleep(getRandomMiniSec()).then(() => {
    ...
    request(options, (error, response, body) => {
      if (error) {
        ...
        const path = `./staticData/fundRich/${currentDateString}FRDetail/${fundRichId}.json`
    ...
    if (fundRichIdList.length <= 0) {
      getMissIdList('fundRich', 'FRDetail', currentDateString, (missIdError, results) => {
        if (missIdError) {
          ...
          console.log(`FRDetail ${currentDateString} no missing ID!`)
        } else {
    ...
    if (fundRichIdList.length <= 0) {
      getMissIdList('fundRich', 'FRDividend', currentDateString, (missIdError, results) => {
        if (missIdError) {
          ...
          console.log(`FRDividend ${currentDateString} no missing ID!`)
        } else {
          console.log(`missId:${results}`)
          for (const id of results) {
            updateOneFundRichDividendDataById(id, currentDateString)
          }
        }
        return 0
      })
    ...
    if (fundRichIdList.length <= 0) {
      getMissIdList('fundRich', 'FRAllocation', currentDateString, (missIdError, results) => {
        if (missIdError) {
          ...
          console.log(`FRAllocation ${currentDateString} no missing ID!`)
        } else {
          console.log(`missId:${results}`)
          for (const id of results) {
            updateOneFundRichAllocationDataById(id, currentDateString)
          }
        }
        return 0
      })
    ...
    if (fundRichIdList.length <= 0) {
      getMissIdList('fundRich', 'FRNav', currentDateString, (missIdError, results) => {
        if (missIdError) {
          ...
          console.log(`FRNav ${currentDateString} no missing ID!`)
        } else {
          console.log(`missId:${results}`)
          for (const id of results) {
            updateOneFundRichNavDataById(id, currentDateString)
          }
        }
        return 0
      })
